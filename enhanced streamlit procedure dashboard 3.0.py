...
#---------------------------------------------------------
#Local OneDrive path that syncs with SharePoint
...
# File to store last seen procedures for highlighting persistence
LAST_SEEN_FILE = os.path.join(SHARED_FOLDER, "last_seen.json")
...
#------------------------------------------------------
# LAST SEEN PROCEDURES PERSISTENCE
#------------------------------------------------------
def load_last_seen():
...
# Load last seen procedures for highlighting persistence
if "last_procs" not in st.session_state:
    st.session_state.last_procs = load_last_seen()
...
# Update session state and persist last seen procedures
if selected_test:
    st.session_state.last_procs[selected_test] = procedures
    save_last_seen(st.session_state.last_procs)
